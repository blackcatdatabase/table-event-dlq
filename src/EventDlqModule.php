...
final class EventDlqModule implements ModuleInterface
{
    public function name(): string { return 'table-event_dlq'; }
    public function table(): string { return 'event_dlq'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_event_dlq_source_time' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_event_dlq_source_time' ],
            'foreignKeys' => [],
        ];
    }
}
