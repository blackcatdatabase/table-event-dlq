...
use BlackCat\Database\Packages\EventDlq\Repository\EventDlqRepository;
...
{
    private EventDlqRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EventDlqRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EventDlq\Dto\EventDlqDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EventDlq\Dto\EventDlqDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EventDlq\Dto\EventDlqDto|null
    {
