...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'event_dlq'; }
    public static function contractView(): string { return 'vw_event_dlq'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'source', 'event_key', 'event', 'error', 'retryable', 'attempts', 'first_failed_at', 'last_failed_at' ]; }
    ...
    public static function jsonColumns(): array { return [ 'event' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'attempts' ]; }
