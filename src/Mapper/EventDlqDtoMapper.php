...
namespace BlackCat\Database\Packages\EventDlq\Mapper;

use BlackCat\Database\Packages\EventDlq\Dto\EventDlqDto;
use BlackCat\Database\Packages\EventDlq\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO EventDlqDto:
...
final class EventDlqDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'attempts' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'event' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'first_failed_at', 'last_failed_at' ];
    /** @var string[] */
     ...
     * @return EventDlqDto
     */
    public static function fromRow(array $row): EventDlqDto
    {
        /** @var EventDlqDto */
    ...
    public static function fromRowOrNull(?array $row): ?EventDlqDto
    {
     ...
     *
     * @param EventDlqDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EventDlqDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EventDlqDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EventDlqDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EventDlqDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EventDlqDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EventDlqDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EventDlqDto>
     */
